...
public class UpdateImageInforTests extends BaseTests {
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление title через ClientID авторизацию ")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление description через ClientID авторизацию")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление title и description через ClientID авторизацию")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление title и description через Token авторизацию")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление description через Token авторизацию")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "UpdateTitle")
    @Description("Обновление title  через Token авторизацию")
    ...
    @Epic("Тестирование https://imgur.com на обновление данных  изображения")
    @Feature(value = "FavoritImage")
    @Description("Присвоение изображению- favorite")
