...
public class UploadImageTests extends BaseTests {
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка валидного изображения ( до 10 Мб")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка большого изображения ( более 10Мб")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка изображения в фомате Base64")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка изображения с параметром name")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка изображения с параметром title")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка изображения с параметром description")
    ...
    @Epic("Тестирование https://imgur.com на загрузку изображения")
    @Feature(value = "uploadImage")
    @Description("Загрузка изображения с некорректными параметрами")
